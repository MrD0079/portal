...
{
	$table_name = "creamcherry_tp_select";
...
$sql=rtrim(file_get_contents('sql/creamcherry_tp_select.sql'));
...
$sql_total=rtrim(file_get_contents('sql/creamcherry_tp_select_total.sql'));
...
$smarty->display('creamcherry_tp_select.html');
?>