...
$sql=rtrim(file_get_contents('sql/os_ac_spr.sql'));
$os_ac_spr = $db->getAll($sql, null, null, null, MDB2_FETCHMODE_ASSOC);
$smarty->assign('os_ac_spr', $os_ac_spr);



$smarty->display('os_ac_spr.html');
