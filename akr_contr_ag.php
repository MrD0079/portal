...
audit("открыл akr_contr_ag","akr");

if (isset($_REQUEST["save"])&&isset($_REQUEST["data"]))
{
	foreach ($_REQUEST["data"] as $k=>$v)
	{
		Table_Update("akr_contr_ag", array("id"=>$k),$v);
	}
}
...
if (isset($_REQUEST["del"]))
{
	...
	{
		Table_Update("akr_contr_ag", array("id"=>$k),null);
	}
}
...
{
	Table_Update("akr_contr_ag", $_REQUEST["new"],$_REQUEST["new"]);
}
...
$smarty->display('akr_contr_ag.html');
