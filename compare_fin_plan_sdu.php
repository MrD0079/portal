...
audit("открыл compare_fin_plan_sdu","fin_plan");
...
{
	$sql=rtrim(file_get_contents('sql/compare_fin_plan_sdu.sql'));
	$sql_total=rtrim(file_get_contents('sql/compare_fin_plan_sdu_total.sql'));
	$params=array(
	...
	$smarty->assign('compare_fin_plan_sdu', $data);
	$smarty->assign('compare_fin_plan_sdu_total', $data_total);
}
...
$smarty->display('compare_fin_plan_sdu.html');
