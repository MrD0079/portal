...
{
	$table_name = "val_bumvesna_tp_select";
...
$sql=rtrim(file_get_contents('sql/val_bumvesna_tp_select.sql'));
...
$sql_total=rtrim(file_get_contents('sql/val_bumvesna_tp_select_total.sql'));
...
$smarty->display('val_bumvesna_tp_select.html');
?>