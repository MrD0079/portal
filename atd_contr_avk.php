...
audit("открыл atd_contr_avk","atd");

if (isset($_REQUEST["save"])&&isset($_REQUEST["data"]))
{
	foreach ($_REQUEST["data"] as $k=>$v)
	{
		Table_Update("atd_contr_avk", array("id"=>$k),$v);
	}
}
...
if (isset($_REQUEST["del"]))
{
	...
	{
		Table_Update("atd_contr_avk", array("id"=>$k),null);
	}
}
...
{
	Table_Update("atd_contr_avk", $_REQUEST["new"],$_REQUEST["new"]);
}
...
$smarty->display('atd_contr_avk.html');
