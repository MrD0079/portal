...
$sql=rtrim(file_get_contents('sql/thing_process.sql'));
$sql=stritr($sql,$params);
$list = $db->getAll($sql, null, null, null, MDB2_FETCHMODE_ASSOC);
$smarty->assign('list', $list);

$sql_total=rtrim(file_get_contents('sql/thing_process_total.sql'));
...
$s2=rtrim(file_get_contents('sql/thing_process_total_total.sql'));
$s2=stritr($s2,$params);
...
$smarty->display('thing_process.html');
