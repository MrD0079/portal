...
InitRequestVar("with_total",1);
InitRequestVar("show_head",1);
$params=array(
    ':tn' => $tn,
    ...
    ':ok_pr' => $_REQUEST["ok_pr"], //<----- убрать это
...
$smarty->display('bud_svod_ta_list_by_db.html');
?>