...
$sql=rtrim(file_get_contents('sql/a13_vo_tp_select.sql'));
...
$sql_total=rtrim(file_get_contents('sql/a13_vo_tp_select_total.sql'));
...
$smarty->display('a13_vo_tp_select.html');
?>