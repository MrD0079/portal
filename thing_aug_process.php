...
$sql=rtrim(file_get_contents('sql/thing_aug_process.sql'));
$sql=stritr($sql,$params);
$list = $db->getAll($sql, null, null, null, MDB2_FETCHMODE_ASSOC);
$smarty->assign('list', $list);

$sql_total=rtrim(file_get_contents('sql/thing_aug_process_total.sql'));
...
$s2=rtrim(file_get_contents('sql/thing_aug_process_total_total.sql'));
$s2=stritr($s2,$params);
...
$sql_total=rtrim(file_get_contents('sql/thing_aug_process_total_parents.sql'));
$sql_total=stritr($sql_total,$params);
...
$smarty->display('thing_aug_process.html');
