...
if (count($rb1)>0)
{
recursive_remove_directory("files/merch_photo_report_new_archives/".$tn,true);
$zip = new ZipArchive();
$archive="files/merch_photo_report_new_archives"."/".$tn."/".$ag_name."_".$_REQUEST["dates_list2"].".zip";
//echo $archive;
$zip->open($archive, ZIPARCHIVE::CREATE);
$file_list=array();
foreach ($rb1 as $k=>$v){
$d1="files/merch_photo_report_new_archives";
$d2=$d1."/".$tn;
...
recursive_remove_directory("files/merch_photo_report_new_archives/".$tn."/".$ag_name,true);
rmdir("files/merch_photo_report_new_archives/".$tn."/".$ag_name);
}
}
