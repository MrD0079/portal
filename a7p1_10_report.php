...
//ses_req();
	...
	$sql = rtrim(file_get_contents('sql/a7p1_10_report_eta_list.sql'));
	$sql=stritr($sql,$params);
	...
	$sql=rtrim(file_get_contents("sql/a7p1_10_report.sql"));
	$sql=stritr($sql,$params);
	//echo $sql;
	...
	$sql_total=rtrim(file_get_contents("sql/a7p1_10_report_total.sql"));
...
$params[':ok_traid'] = $_REQUEST["ok_traid"];
$sql=rtrim(file_get_contents('sql/a7p1_10_report_files.sql'));
$sql=stritr($sql,$params);
...
$params[':exp_list_only_ts'] = $_REQUEST["exp_list_only_ts"];
$params[':ok_traid'] = $_REQUEST["ok_traid"];
$sql=rtrim(file_get_contents('sql/a7p1_10_report_files_total.sql'));
$sql=stritr($sql,$params);
$d = $db->getAll($sql, null, null, null, MDB2_FETCHMODE_ASSOC);
...
$params[':exp_list_only_ts'] = $_REQUEST["exp_list_only_ts"];
$params[':ok_traid'] = $_REQUEST["ok_traid"];
$sql=rtrim(file_get_contents('sql/a7p1_10_report_files_total_total.sql'));
$sql=stritr($sql,$params);
$d = $db->getOne($sql);
...
$smarty->display('a7p1_10_report.html');
