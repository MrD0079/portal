...
if (isset($_REQUEST['fn']))
{
	...
	Table_Update('azl_files',$keys,null);
	unlink('azl_report_photo/'.$_REQUEST['fn']);
}
...
if (isset($_FILES['fotoreport']))
{
	...
	)
	{
		...
		Table_Update('azl_files',$keys,$keys);

		move_uploaded_file($_FILES['fotoreport']['tmp_name'], 'azl_report_photo/'.$fn);
		$smarty->assign('fn',$fn);
		$smarty->display('azl_report_files.html');
	}
	else
	{
