...
if (isset($_REQUEST["del"]))
{
	...
	{
		$db->extended->autoExecute("merch_report_sb_comm", null, MDB2_AUTOQUERY_DELETE, "id=".$k);
	}
}

if (isset($_REQUEST["new"]))
{
	$affectedRows = $db->extended->autoExecute("merch_report_sb_comm", array("name"=>$_REQUEST["new_name"]), MDB2_AUTOQUERY_INSERT);
}
