...
//audit("������ ������� ".$emp_tn." �� ".$_REQUEST["month_list"],"zat");
	...
	if (isset($_REQUEST["zat_monthly"]))
	{
		...
		if (isset($_REQUEST["zat_monthly"]["is_accepted"]))
		{
			...
			if ($accepted_changed==1)
			{
				...
				$subj="��������� ������� ������ � �������� �� ".$period;
				$text="������������.<br>";
				$text.="������ ������ ������ � �������� �� ".$period." ������� ".$who." � '".$status."'-'".Int2Text($is_accepted)."' �� '".$status."'-'".Int2Text($_REQUEST["zat_monthly"]["is_accepted"])."'.<br>";
				$text.="����� ���������: ".$now_date_time.".";
				send_mail($email,$subj,$text,null);
				audit("������ ������ � �������� ".$emp_tn." �� ".$_REQUEST["month_list"]." ������� ".$who." � '".$status."'-'".Int2Text($is_accepted)."' �� '".$status."'-'".Int2Text($_REQUEST["zat_monthly"]["is_accepted"]),"zat");
                        }
		}
		if (isset($_REQUEST["zat_monthly"]["is_processed"]))
		{
			...
			if ($processed_changed==1)
			{
				...
				$subj="��������� ������� ������ � �������� �� ".$period;
				$text="������������.<br>";
				$text.="������ ������ ������ � �������� �� ".$period." ������� ".$who." � '".$status."'-'".Int2Text($is_processed)."' �� '".$status."'-'".Int2Text($_REQUEST["zat_monthly"]["is_processed"])."'.<br>";
				$text.="����� ���������: ".$now_date_time.".";
				send_mail($email,$subj,$text,null);
				audit("������ ������ � �������� ".$emp_tn." �� ".$_REQUEST["month_list"]." ������� ".$who." � '".$status."'-'".Int2Text($is_processed)."' �� '".$status."'-'".Int2Text($_REQUEST["zat_monthly"]["is_processed"]),"zat");
			}
		}
	}
}
...
if (isset($_REQUEST["del_file"]))
{
	...
	{
		unlink($v);
		audit("������ ���� ".$v." �� ������ ".$emp_tn." �� ".$_REQUEST["month_list"],"zat");
	}
}
...
foreach ($_FILES as $k=>$v)
{
	foreach ($v["name"] as $k1=>$v1)
	{
		...
		if (is_uploaded_file($v['tmp_name'][$k1])){
			...
			audit("������� �������� ���� ".translit($v["name"][$k1])." � �������� ".$emp_tn." �� ".$_REQUEST["month_list"],"zat");
		}
	}
}
...
{
	audit("�������� ���� ".$_REQUEST["car"]." � �������� ".$emp_tn." �� ".$_REQUEST["month_list"],"zat");
	$keys = array(
		"svideninn"=>$emp_tn,
	);
	$vals = $_REQUEST["car"];
