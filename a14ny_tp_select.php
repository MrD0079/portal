...
$sql=rtrim(file_get_contents('sql/a14ny_tp_select.sql'));
$sql=stritr($sql,$params);
$tp = $db->getAll($sql, null, null, null, MDB2_FETCHMODE_ASSOC);
$smarty->assign('tp', $tp);

$sql_total=rtrim(file_get_contents('sql/a14ny_tp_select_total.sql'));
...
$smarty->display('a14ny_tp_select.html');
?>