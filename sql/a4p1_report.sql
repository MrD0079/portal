/* Formatted on 11.09.2012 16:14:04 (QP5 v5.163.1008.3004) */
  SELECT d.tab_num,
         ...
         d.action_qt_ya,
         CASE
            WHEN d.oltype_id <> 15 AND d.action_qt_ya >= 4 THEN 1
            WHEN d.oltype_id = 15 AND d.action_qt_ya >= 8 THEN 1
            ELSE 0
         END
            action_nakl,
         CASE
            WHEN d.oltype_id <> 15 THEN TRUNC (d.action_qt_ya / 4)
            WHEN d.oltype_id = 15 THEN TRUNC (d.action_qt_ya / 8)
            ELSE 0
         END
            max_ya,
