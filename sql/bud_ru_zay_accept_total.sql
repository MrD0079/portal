/* Formatted on 12.01.2018 13:14:05 (QP5 v5.252.13127.32867) */
SELECT COUNT (DISTINCT id) c,
  ...
  FROM (  SELECT bud_ru_zay.id,
                 ...
                 get_bud_ru_zay_cur_acceptor_tn (bud_ru_zay.id)
                    current_acceptor_tn,
                 DECODE (get_bud_ru_zay_cur_acceptor_tn (bud_ru_zay.id),
                         :tn, 1,
                         0)
                    allow_status_change,
                 fn_getname (
