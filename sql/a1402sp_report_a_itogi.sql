/* Formatted on 24.01.2014 16:18:19 (QP5 v5.227.12220.39724) */
SELECT COUNT (DISTINCT an.H_TP_KOD_DATA_NAKL) cnt_nakl,
       COUNT (DISTINCT tp.tp_kod) cnt_tp,
       SUM (d.summa) summa,
       SUM (decode(an.bool_tip,1,1,0)) bool1,
       SUM (decode(an.bool_tip,2,1,0)) bool2,
       ...
       * 100
          zat
  FROM a1402sp d,
       a1402sp_action_nakl an,
       user_list st,
       a1402sp_tp_select tp
