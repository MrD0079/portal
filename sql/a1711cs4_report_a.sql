/* Formatted on 19.08.2017 12:36:30 (QP5 v5.252.13127.32867) */
SELECT d.tp_kod,
       d.plan,
       d.fact,
       DECODE (NVL (d.plan, 0), 0, 0, d.fact / d.plan * 100) perc,
       CASE WHEN DECODE (NVL (d.plan, 0), 0, 0, d.fact / d.plan * 100) >= 100 THEN NVL (d.fact, 0) * 0.04 END max_bonus,
       d.fio_eta,
       d.tp_ur,
       d.tp_addr,
       tp.bonus_sum1,
       ...
       st.fio ts_fio,
       st.tn ts_tn
  FROM a1711cs4 d, user_list st, a1711cs4_select tp
