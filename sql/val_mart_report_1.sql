/* Formatted on 11.01.2013 13:51:59 (QP5 v5.163.1008.3004) */
SELECT z.*,
       CASE
       ...
       END
          perc_total,
       CASE WHEN (sales_mart + sales_apr - sales_fevr * 1.5) < 0 THEN 0 ELSE (sales_mart + sales_apr - sales_fevr * 1.5) END rost_total,
       CASE WHEN (sales_mart + sales_apr - sales_fevr * 1.5) / 10 < 0 THEN 0 ELSE (sales_mart + sales_apr - sales_fevr * 1.5) / 10 END bonus
