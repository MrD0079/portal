/* Formatted on 24.01.2014 16:30:06 (QP5 v5.227.12220.39724) */
  SELECT d.tab_num,
         st.fio fio_ts,
         d.fio_eta,
         d.tp_ur,
         ...
         d.summa,
         an.bool_tip,
         CASE WHEN bool1 = 1 THEN 1 ELSE 0 END bool1,
         CASE WHEN /*TTABC in ('B','C') and */bool2 = 1 THEN 1 ELSE 0 END bool2,
         CASE WHEN bool1 = 1 or (/*TTABC in ('B','C') and */bool2 = 1) THEN 1 ELSE 0 END if1,
    ...
    FROM a1402zv d, a1402zv_action_nakl an, user_list st
