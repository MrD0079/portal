/* Formatted on 24/05/2016 16:46:07 (QP5 v5.252.13127.32867) */
            ...
            FROM (  SELECT tf.fil_id,
                      ...
                      FROM (  SELECT f.id fil_id,
                           ...
                           (  SELECT TRUNC (z.dt_start, 'mm') period,
                            ...
                            GROUP BY z.fil, z.funds, TRUNC (z.dt_start, 'mm'))
                           zay,
                           (  SELECT t.dt period,
                                     z.fil,
                                     z.funds,
