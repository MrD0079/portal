/* Formatted on 15/06/2016 13:51:51 (QP5 v5.252.13127.32867) */
  SELECT an.id,
         ...
         nvl(d.act_nabor_1,0) * nvl(d.nakl_summ,0) * 0.10 +
         nvl(d.act_nabor_2,0) * nvl(d.nakl_summ,0) * 0.12 +
         nvl(d.act_nabor_3,0) * nvl(d.nakl_summ,0) * 0.15 max_bonus,
         ...
         st.tn ts_tn
    FROM a1704ca d,
         a1704ca_action_nakl an,
         user_list st,
         a1704ca_tp_select tp
