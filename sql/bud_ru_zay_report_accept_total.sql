/* Formatted on 24/10/2014 14:24:44 (QP5 v5.227.12220.39724) */
  SELECT current_status,
    ...
    FROM (SELECT DISTINCT z.id,
            ...
            FROM (SELECT z.id,
                         ...
                         CASE
                            WHEN TRUNC (SYSDATE) <= TRUNC (z.report_data)
                            THEN
                               1
                         END
                            srok_ok,
                         ...
                         fu.name funds_name,
                         n.net_name,
                         z.report_short,z.distr_compensation
                    FROM bud_ru_zay z,
           ...
           WHERE     DECODE (:wait4myaccept, 0, :tn, 0) =
                 ...
                 AND current_accepted_id = 464260) z
