/* Formatted on 24/06/2015 16:07:37 (QP5 v5.227.12220.39724) */
  SELECT current_status,
         (SELECT name1
            FROM bud_ru_zay_accept_types
    ...
    FROM (SELECT DISTINCT
                 ...
                 CASE
                    ...
                    THEN
                       CASE
                          WHEN is_traid = 1 AND net_name IS NULL THEN 1
                          WHEN is_traid_kk = 1 AND net_name IS NOT NULL THEN 1
                          ELSE 0
                       END
                    ELSE
                       1
            ...
            FROM (SELECT bud_ru_zay.id,
                         TO_CHAR (bud_ru_zay.created, 'dd.mm.yyyy hh24:mi:ss')
                            created,
