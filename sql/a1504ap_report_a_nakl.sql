/* Formatted on 24/04/2015 11:41:00 (QP5 v5.227.12220.39724) */
  SELECT d.tab_num,
         st.fio fio_ts,
         d.fio_eta,
         d.tp_ur,
         ...
         d.nakl_summ,
         CASE WHEN d.qty_akc >= 1 AND d.Qty_truf >= 1 THEN 1 ELSE 0 END if1,
         ...
         DECODE ( (SELECT COUNT (*)
                     FROM (SELECT h_tp_kod_data_nakl FROM a1504cy_action_nakl
                           UNION
    ...
    FROM a1504ap d, a1504ap_action_nakl an, user_list st
