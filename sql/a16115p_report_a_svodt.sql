/* Formatted on 16.11.2016 17:30:23 (QP5 v5.252.13127.32867) */
INSERT INTO act_svodt (act,
     ...
     SELECT act,
       ...
       FROM (SELECT :act act,
                    :month m,
                    tplist.tp_kod,
                    GREATEST (NVL (part1.sales, 0),   /*NVL (part2.sales, 0)*/
                                                   0) sales,
                    NVL (part1.bonus, 0)           /* + NVL (part2.bonus, 0)*/
                                        bonus,
                    NVL (part1.fio_db,                        /*part2.fio_db*/
                                      0) fio_db,
                    NVL (part1.fio_ts,                        /*part2.fio_ts*/
                                      0) fio_ts,
                    NVL (part1.ts_tab_num,                /*part2.ts_tab_num*/
                                          0) ts_tab_num,
                    NVL (part1.fio_eta,                      /*part2.fio_eta*/
                                       0) fio_eta,
                    NVL (part1.h_fio_eta,                  /*part2.h_fio_eta*/
                                         0) h_fio_eta,
