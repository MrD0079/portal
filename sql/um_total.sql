/* Formatted on 27/02/2015 12:00:43 (QP5 v5.227.12220.39724) */
SELECT SUM (ts_visa) ts_visa,
       SUM (plan_ev) plan_ev,
       SUM (plan_val) plan_va,
       SUM (plan_c1) plan_c1,
       SUM (plan_c2) plan_c2,
       SUM (plan_c3) plan_c3,
       SUM (um_posted) um_posted
  FROM (/* Formatted on 27/02/2015 12:00:06 (QP5 v5.227.12220.39724) */
  SELECT um.fio_ts,
         um.tab_num,
         um.fio_eta,
         um.tp_kod,
