/* Formatted on 27/03/2015 16:11:40 (QP5 v5.227.12220.39724) */
  SELECT an.id,
         d.nakl,
         ...
         d.truf_Summ,
           CASE
              WHEN TRUNC (d.nakl_summnds / 1500) > 2 THEN 2
              ELSE TRUNC (d.nakl_summnds / 1500)
           END
         * 310
            max_bonus,
         d.tp_addr,
         ...
         st.tn ts_tn
    FROM a1503mg d,
         a1503mg_action_nakl an,
         user_list st,
         a1503mg_tp_select tp
