/* Formatted on 11.01.2014 12:33:32 (QP5 v5.227.12220.39724) */
SELECT COUNT (DISTINCT tp_kod) cnt,
       SUM (DECODE (vo1, NULL, NULL, 1)) vo1,
       SUM (prev) prev,
       SUM (summa) summa,
       SUM (DECODE (nv1, NULL, NULL, 1)) nv1,
  ...
  FROM (  SELECT tp.*,
        ...
        ORDER BY parent_fio, ts_fio, tp.fio_eta)