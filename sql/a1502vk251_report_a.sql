/* Formatted on 03/03/2015 10:45:38 (QP5 v5.227.12220.39724) */
  SELECT an.id,
         d.nakl,
         ...
         d.nakl_summnds,
         d.vk_weight,
           LEAST (2, TRUNC (d.vk_weight / 20))
         * CASE
              WHEN d.chanel_type = 1 THEN 80
              WHEN d.chanel_type = 2 THEN 150
              WHEN d.chanel_type = 3 THEN 300
           END
            max_bonus,
         d.tp_addr,
