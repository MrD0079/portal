/* Formatted on 21.03.2013 16:31:13 (QP5 v5.163.1008.3004) */
  SELECT d.tab_num,
         ...
         d.summa,
         decode(nvl (d.ksk, 0),0,'нет','да') ksk,
         decode(nvl (d.sharm, 0),0,'нет','да') sharm,
         decode(nvl (d.vf, 0),0,'нет','да') vf,
         decode(nvl (d.ksk, 0)+nvl (d.sharm, 0)+nvl (d.vf, 0),3,1,0) is_act,
         --d.packveskonf,
         --d.SUMmshok,
         --d.SUMMvespech,
    ...
    FROM a13_7p1 d, a13_7p1_action_nakl an, user_list st
