/* Formatted on 07.11.2017 17:35:28 (QP5 v5.252.13127.32867) */
SELECT SUM (sales_fact) sales_fact,
  ...
  FROM (  SELECT x.fil_id,
                 ...
                 SUM (CASE WHEN x.fnd_kod = 'gbo' THEN x.gsm_total ELSE NULL END)
                    gsm_total,
                 SUM (
                    CASE WHEN x.fnd_kod = 'prm' THEN x.promo_total ELSE NULL END)
                    promo_total,
            ...
            FROM (  SELECT tf.fil_id,
                           ...
                           NVL (zp.total1, 0) + NVL (zay.compens_distr, 0)
                              gsm_total,
                           zp.sales,
                           taf.prot_db,
                           taf.ok_db_tn,
                           ...
                           (  SELECT zp.fil,
                                ...
                                FROM (SELECT m.tab_num,
                                       ...
                                       WHERE     m.dpt_id = :dpt_id
                                             AND m.dt = TO_DATE ( :dt, 'dd.mm.yyyy'))
                                     s,
                                     user_list u,
                                     sc_tp t,
                                     sc_svod sv,
                                                    ...
                                                    FROM (SELECT tpn.net_kod,
                                                         ...
                                                         (SELECT DISTINCT
                                                           ...
                                                           WHERE     (SELECT NVL (tu, 0)
                                                                 ...
                                                                 AND TO_DATE (
                                                                        :dt,
                                                                        'dd.mm.yyyy') /*= z.cost_assign_month*/
                                                                                     BETWEEN TRUNC (
                                                                                                z.dt_start,
                                                                                                'mm')
                                                                                         AND TRUNC (
