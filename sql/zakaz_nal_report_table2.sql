/* Formatted on 13.01.2017 22:21:52 (QP5 v5.252.13127.32867) */
  SELECT rmkk,
         rmkk_name,
         lu,
         ok,
    ...
    FROM (/* Formatted on 13.01.2017 22:21:40 (QP5 v5.252.13127.32867) */
  SELECT rmkk,
         rmkk_name,
         mkk_ter,
         mkk_name,
    ...
    FROM (  SELECT rmkk,
              ...
              FROM (  SELECT m.rmkk,
                             ...
                             ptm.ok_nm,
                             ptm.ok_fm,
                             TO_CHAR (ptm.ok_tm_lu, 'dd.mm.yyyy hh24:mi:ss')
                                ok_tm_lu,
                             TO_CHAR (ptm.ok_nm_lu, 'dd.mm.yyyy hh24:mi:ss')
                                ok_nm_lu,
