/* Formatted on 09/04/2015 12:49:29 (QP5 v5.227.12220.39724) */
SELECT emp_dolgn "Должность",
       emp_tn "т.н.",
       emp_name "Ф.И.О.",
       datauvol "Дата увольнения",
       rep_date "Отчетный период",
       avans "Аванс",
       cost_transp "Транспортные расходы",
       cost_kom "Командировочные расходы",
       present_cost "Представительские расходы",
       stationery "Канцелярия",
       media_advert "Объявления в СМИ",
       mail "Почта",
       conference "Конференцзал",
       training_food "Питание участников тренинга",
       esv "ЕСВ",
       account_payments "Оплата услуг ведения счета",
