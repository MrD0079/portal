/* Formatted on 09.02.2017 15:05:25 (QP5 v5.252.13127.32867) */
  SELECT rmkk,
         rmkk_name,
         ...
         SUM (faktoplachusl_cur_total) faktoplachusl_cur_total,
         SUM (faktoplachusl_prev_total) faktoplachusl_prev_total,
    ...
    FROM (  SELECT rmkk,
                   ...
                   + NVL (SUM (sum_per), 0)
                   - NVL (SUM (faktoplachusl_cur_total), 0)
                      remain,
                                                     ...
                                                     WHERE     data = TRUNC (data, 'mm')
                                                           ...
                                                           AND TRUNC (data, 'mm') BETWEEN TO_DATE (
                                                                                      ...
                                                                                      AND TO_DATE (
                                                                                             ...
                                                                                             'dd.mm.yyyy')
                                                  ORDER BY data) c,
                                                 (  SELECT fn_getname (n2.tn_rmkk)
                                                              rmkk_name,
                                                           n2.tn_rmkk rmkk,
                                                           fn_getname (list.mkk_ter)
                                                              mkk_name,
                                                           list.mkk_ter,
                                                           n2.net_name,
                                                           MAX (
