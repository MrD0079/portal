/* Formatted on 24/04/2015 11:39:58 (QP5 v5.227.12220.39724) */
  SELECT an.id,
         d.nakl,
         ...
         d.qty_truf,
           CASE
              WHEN TRUNC (d.Qty_Akc / 4) > 2 THEN 2
              ELSE TRUNC (d.Qty_Akc / 4)
           END
         * 100
            max_bonus,
         d.tp_addr,
         ...
         st.tn ts_tn
    FROM a1504cy d,
         a1504cy_action_nakl an,
         user_list st,
         a1504cy_tp_select tp
