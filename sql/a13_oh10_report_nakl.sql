/* Formatted on 01.11.2013 14:32:15 (QP5 v5.227.12220.39724) */
  SELECT d.tab_num,
         st.fio fio_ts,
         d.fio_eta,
         d.tp_ur,
         ...
         /*d.CHER420Q,*/
         CASE
            WHEN     NVL (boxqtyc1, 0) + NVL (boxqtysah, 0) >= 7
                 AND NVL (boxqtyc2, 0) >= 3
            THEN
               1
            ELSE
               0
    ...
    FROM a13_oh10 d, a13_oh10_action_nakl an, user_list st
