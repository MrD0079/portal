/* Formatted on 11/05/2016 09:42:36 (QP5 v5.252.13127.32867) */
SELECT COUNT (DISTINCT h_net) cnt_tp,
       COUNT (DISTINCT DECODE (max_bonus, NULL, NULL, h_net)) if_cnt,
       SUM (fakt3) fakt3,
       SUM (plan4) plan4,
       SUM (fakt4) fakt4,
       SUM (max_bonus) max_bonus,
       SUM (bonus_sum1) bonus_sum1,
       SUM (bonus_dt1) bonus_fakt_cnt,
  ...
  FROM (  SELECT h_net,
                 ...
                 * 100
                 ...
                 COUNT (*) tp_cnt,
                 SUM (bonus_sum1) bonus_sum1,
                 COUNT (DISTINCT DECODE (bonus_dt1, NULL, NULL, h_net))
                    bonus_dt1,
