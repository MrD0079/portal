/* Formatted on 22/12/2014 17:15:28 (QP5 v5.227.12220.39724) */
  SELECT ff.id, ff.name, ff.sort, count(distinct z.id) z_cnt
    FROM bud_ru_zay z,
         bud_ru_zay_ff zf,
         bud_ru_st_ras st,
         bud_ru_ff ff
   WHERE     z.id = zf.z_id
         ...
         AND z.id IN
                (select distinct id from (/* Formatted on 03/02/2016 18:31:11 (QP5 v5.252.13127.32867) */
