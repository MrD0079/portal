/* Formatted on 27.11.2013 14:11:31 (QP5 v5.227.12220.39724) */
  SELECT d.tab_num,
         st.fio fio_ts,
         d.fio_eta,
         d.tp_ur,
         ...
         d.gr5,
         d.boxqtyc2,
         CASE WHEN gr1 + gr2 + gr3 + gr4 + gr5 = 5 THEN 1 ELSE 0 END if1,
         NVL (an.if1, 0) selected_if1,
         an.ok_traid,
         an.ok_chief,
         an.bonus_sum1,
         d.H_TP_KOD_DATA_NAKL
    FROM a13_yc d, a13_yc_action_nakl an, user_list st
