/* Formatted on 03.02.2014 12:03:47 (QP5 v5.227.12220.39724) */
  SELECT tn,
         fio,
         fio_otv,
         num,
         ...
         SUM (delta) delta,
         SUM (minutes) minutes,
         SUM (gps_delta) gps_delta,
         SUM (work_day_is_red) work_day_is_red,
         SUM (tp_cnt) tp_cnt,
         SUM (gps_tp_cnt) gps_tp_cnt,
         SUM (gps_delta_tp) gps_delta_tp
    FROM (  SELECT id,
                   dt,
                   dt1,
                   tn,
                   ...
                   DECODE (
                      ...
                      || ROUND (
                              60
                            * MOD (24 * (MAX (max_time_out) - MIN (min_time_in)),
                                   1)))
                      work_day_time,
                   ...
                   DECODE (
                      SIGN (
                           510
                         - (60 * 24 * (MAX (max_time_out) - MIN (min_time_in)))),
                      1, 1,
                      0)
                      work_day_is_red,
              ...
              FROM (  SELECT DISTINCT
                             ...
                             q1.plan_tp_ok,
                             q1.fakt_tp_ok,
                             DECODE (q1.fakt_tp_ok, 0, NULL, g.gps_kod_tp)
                                gps_kod_tp,
