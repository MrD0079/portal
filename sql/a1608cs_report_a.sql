/* Formatted on 15/06/2016 13:51:51 (QP5 v5.252.13127.32867) */
  SELECT an.id,
         ...
         nvl(d.act_summ_v1,0) * 17.31 +
         nvl(d.act_summ_v2,0) * 55.62 +
         nvl(d.act_summ_v3,0) * 20.6 +
         nvl(d.act_summ_v4,0) * 18.47 +
		 nvl(d.act_summ_v5,0) * 12.88 max_bonus,
         --TRUNC (d.act_summ / 2) max_bonus2,
         d.tp_addr,
         ...
         st.tn ts_tn
    FROM a1608cs d,
         a1608cs_action_nakl an,
         user_list st,
         a1608cs_tp_select tp
