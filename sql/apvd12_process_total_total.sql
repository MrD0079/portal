/* Formatted on 11.01.2013 13:00:50 (QP5 v5.163.1008.3004) */
SELECT fn_apvd_ball (DECODE (:apvd12_ts_list, 0, DECODE (:apvd12_chief_list, 0, :tn, :apvd12_chief_list), :apvd12_ts_list)) ball,
       a10akb,
       a10s1,
       a10s2,
       a10s3,
