/* Formatted on 20.07.2017 14:25:59 (QP5 v5.252.13127.32867) */
  SELECT an.id,
         d.nakl,
         ...
         NVL (d.act_nabor_1, 0) * 171 + NVL (d.act_nabor_2, 0) * 131 + NVL (d.act_nabor_3, 0) * 131
            max_bonus,
         ...
         st.tn ts_tn
    FROM a1712es d,
         a1712es_action_nakl an,
         user_list st,
         a1712es_tp_select tp
