/* Formatted on 22.02.2013 15:45:44 (QP5 v5.163.1008.3004) */
  SELECT d.tab_num,
         ...
         d.QTYSKUFK,
         d.CREAM_CHERRY_QTY,
         CASE WHEN d.QTYSKUFK >= 4 AND d.CREAM_CHERRY_QTY >= 1 AND d.SUMMNDS_FK >= 85 THEN 1 ELSE 0 END if1,
         CASE WHEN d.QTYSKUFK >= 7 AND d.CREAM_CHERRY_QTY >= 1 AND d.SUMNDS_CREAM_CHER >= 48 AND d.SUMMNDS_FK >= 150 THEN 1 ELSE 0 END if2,
