/* Formatted on 15/08/2016 14:15:38 (QP5 v5.252.13127.32867) */
  SELECT an.id,
         d.nakl,
         ...
         d.nakl_summ,
         d.act_nabor_1,
         /* TRUNC (d.act_nabor_1 / 1000) * 100 */
         NVL (d.act_nabor_1, 0) * 185.64 max_bonus,
         --TRUNC (d.act_nabor_1 / 2) max_bonus2,
         d.tp_addr,
         NVL (an.if1, 0) selected_if1,
         /*case when an.if1 = 2 then d.act_nabor_1 else 0 end sert_cnt,*/
         an.bonus_sum1,
         an.bonus_sum2,
         an.fn,
         ...
         st.tn ts_tn
    FROM a1610s7 d,
         a1610s7_action_nakl an,
         user_list st,
         a1610s7_tp_select tp
