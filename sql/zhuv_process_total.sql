/* Formatted on 11.01.2013 14:02:23 (QP5 v5.163.1008.3004) */
  SELECT fio,
         COUNT (*) c,
         tab_num,
         DECODE (SIGN (SUM (june) - SUM (may)), 1, SUM (june) - SUM (may), 0) d_jm,
