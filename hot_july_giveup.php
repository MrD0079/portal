...
for ($i=1;$i<=2;$i++)
{
	...
	$sql=rtrim(file_get_contents("sql/hot_july_giveup_".$i.".sql"));
	$sql=stritr($sql,$params);
	//echo $sql;
	...
	$sql_total=rtrim(file_get_contents("sql/hot_july_giveup_".$i."_total.sql"));
...
$smarty->display('hot_july_giveup.html');
