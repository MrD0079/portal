...
//	$_SESSION["plan_type"]=$_REQUEST["plan_type"];
	...
	$sql=rtrim(file_get_contents('sql/rep_compare_nets.sql'));
	$sql_total=rtrim(file_get_contents('sql/rep_compare_nets_total.sql'));
	$params=array(
...
//		':plan_type'=>$_REQUEST["plan_type"],
	...
	$smarty->assign('rep_compare_nets', $data);
	$smarty->assign('rep_compare_nets_total', $data_total);
}
...
$smarty->display('rep_compare_nets.html');
