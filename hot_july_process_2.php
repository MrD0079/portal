...
$sql=rtrim(file_get_contents('sql/hot_july_process_2.sql'));
$sql=stritr($sql,$params);
...
$params=array(':dpt_id' => $_SESSION["dpt_id"],':tn'=>$tn,':tp_kat'=>1,':pt'=>$_REQUEST["pt"],':eta_list' => "'".$_REQUEST["eta_list"]."'");
$sql=rtrim(file_get_contents('sql/hot_july_process_2_total.sql'));
$sql=stritr($sql,$params);
$tp = $db->getAll($sql, null, null, null, MDB2_FETCHMODE_ASSOC);
//echo $sql;
...
$smarty->display('hot_july_process_2.html');
?>