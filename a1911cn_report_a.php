...
if (isset($_REQUEST["generate"]))
{
    ...
    $ss = "select c.y,c.my from bud_act_fund b,calendar c where b.act='".$_REQUEST['act']."' and b.act_month=c.data";
    echo $ss;
    echo $db->getRow($ss, null, null, null, MDB2_FETCHMODE_ASSOC);
    //echo var_dump($sql);
    echo "</pre>";
    //echo $sql;
